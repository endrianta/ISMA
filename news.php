        ...
        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
          <div class="col-md-6 col-lg-3 news-item" data-aos="fade-up">
            <div class="card shadow-sm border-0 h-100">
              <img src="assets/img/news/<?php echo $row['image']; ?>" class="card-img-top" alt="<?php echo $row['title']; ?>" />
              <div class="card-body">
                <h5 class="card-title"><?php echo $row['title']; ?></h5>
                <p class="card-text">
                  <?php echo substr(strip_tags($row['content']), 0, 80); ?>...
                </p>
                <small class="text-muted d-block mb-2"><?php echo $row['date']; ?> | <?php echo $row['author']; ?></small>
                <a href="detail_news.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Baca Selengkapnya</a>
              </div>
            </div>
          </div>
        <?php endwhile; ?>
