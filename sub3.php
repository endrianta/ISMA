...
<html lang="en">
  <head>
    ...
    <title>Bisnis Proses dan Layanan PT. ISMA</title>
        ...
        <div class="row g-4">
          <div class="col-md-6" data-aos="zoom-in">
            <div class="service-card shadow-sm rounded-4 overflow-hidden h-100">
              <img src="assets/img/awak kapal.jpg" class="img-fluid service-img" alt="Tenaga Awak Kapal" />
          ...
          <div class="col-md-6" data-aos="zoom-in" data-aos-delay="150">
            <div class="service-card shadow-sm rounded-4 overflow-hidden h-100">
              <img src="assets/img/maritim pilot.jpg" class="img-fluid service-img" alt="Maritime Pilot" />
