...
<head>
<meta charset="UTF-8">
<title>Tambah Moment - PT. ISMA</title>
...
<body>
<header><h1>Tambah Moment</h1></header>
<div class="container">
<h2>Tambah Moment Baru</h2>
...
if(isset($_POST['save'])){
    ...
    $new_name   = $image;
    $targetPath = "../assets/img/moment/".$new_name;
    ...
    // Simpan ke database
    $sql = "INSERT INTO moment (title, image) VALUES ('$title','$new_name')";
    if(mysqli_query($conn,$sql)){
        header("Location: moment.php");
        exit;
    } else {
        echo "<p style='color:red;text-align:center;'>Gagal menyimpan moment!</p>";
    }
}
?>
</body>
