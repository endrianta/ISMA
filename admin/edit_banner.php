    ...
    if(isset($_POST['update'])){
        ...
        if(!empty($_FILES['image']['name'])){
            ...
            if(in_array($ext,$allowed)){
                ...
                $target = "../assets/img/banner/".$new_name;
                ...
                if(move_uploaded_file($file_tmp,$target)){
                    ...
                    if(!empty($data['image']) && file_exists("../assets/img/banner/".$data['image'])){
        ...
        if(mysqli_query($conn,$sql)){
            header("Location: edit_banner.php?id=$id&success=1");
            exit;
        } else {
            echo "<p style='color:red;text-align:center;'>Gagal update banner!</p>";
        }
    }
?>
<!DOCTYPE html>
<html lang="id">
    <head>
        <meta charset="UTF-8">
        <title>Edit Banner - PT. ISMA</title>
    ...
    <body>
        <header><h1>Edit Banner</h1></header>
        <div class="container">
            <h2>Edit Banner</h2>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="preview">
                    ...
                    <?php if(!empty($data['image'])): ?>
                        <img src="../assets/img/banner/<?= htmlspecialchars($data['image']) ?>" alt="Gambar Banner">
                    <?php else: ?>
            ...
            <a href="banner.php" class="back-link">← Kembali ke Daftar Banner</a>
        </div>
    </body>
</html>